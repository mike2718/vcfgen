...
//用法：
//  % gcc -Wall -Wpedantic -Wextra -Werror -g -O0 -std=c99 -o vcfgen vcfgen.c
//  % ./vcfgen
#include <stdio.h>
int main(void)
{
    ...
    fprintf(fp, "FN:%s\r\n", xm);
    fprintf(fp, "TEL;TYPE=cell,voice:%s\r\n", sj);
    fprintf(fp, "EMAIL;TYPE=internet:%s\r\n", yx);
    //fprintf(fp, "URL:%s\r\n", wz);
